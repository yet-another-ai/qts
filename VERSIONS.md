...
| `rocm` | ⬜ | ✅ | ⬜ | ⬜ | ✅ | Enables the ONNX Runtime ROCm execution provider for the vocoder. Runtime: select with `QWEN3_TTS_VOCODER_EP=rocm` or include `rocm` in `QWEN3_TTS_VOCODER_EP_FALLBACK`. |
